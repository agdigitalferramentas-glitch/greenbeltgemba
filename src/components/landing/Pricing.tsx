      ...
      <div className="mt-10 sm:mt-14 max-w-[700px] mx-auto rounded-2xl border-2 border-green-vibrant/40 bg-card shadow-deep">
        ...
        <div className="px-5 sm:px-9 py-7 sm:py-8">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 w-full px-3 sm:px-6 py-3 sm:py-4 rounded-md border-2 font-bold text-sm sm:text-base text-center leading-tight transition-colors"
